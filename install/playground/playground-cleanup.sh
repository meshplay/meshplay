...
valid_namespaces=("kube-system" "default" "monitoring" "kube-flannel" "kube-node-lease" "kube-public" "meshplay" "metallb-system" "projectcontour" "ingress-nginx" "khulnasoft-cloud" "postgres")
