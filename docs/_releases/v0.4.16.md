...
- General
  ...
  - [meshplayctl] Add prerequisite on docker daemon running status @hexxdump (#1746)
  ...
  - [Docs] fixes #1748 SVG of Meshplay Architecture Diagram @DanRowe1 (#1760)
  ...
  - generate default meshplayctl config if one doesn't exist or invalid on… @anirudhjain75 (#1693)
